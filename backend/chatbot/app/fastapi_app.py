...
# Use settings for Qdrant connection configuration
router = DataRouter(
    ayahs_json_path="./metadata/ayahs_collection.json",
...
def query(req: QueryRequest):
    ...
    if req.show_tafsir and tafsir_full:
        tafsir_snippet = tafsir_full[:1200] + ("…" if len(tafsir_full) > 1200 else "")
